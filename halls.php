...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['submit_booking'])) {
        ...
        if (!empty($selected_amenities)) {
            ...
            $amenity_stmt = $pdo->prepare("SELECT SUM(price) as total FROM hall_amenities WHERE id IN ($placeholders) AND is_available = 1");
                ...
                <div class="bg-[#F5F5F5]/10 backdrop-blur-lg rounded-2xl p-6 sticky top-24 border border-[#C9A45A]/20">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="text-[#F5F5F5]" id="hallPrice">₦0</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-[#F5F5F5]/70">Package:</span>
                            <span class="text-[#F5F5F5]" id="packagePrice">₦0</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-[#F5F5F5]/70">Amenities:</span>
                            <span class="text-[#F5F5F5]" id="amenitiesPrice">₦0</span>
                        </div>
                        <div class="border-t border-[#C9A45A]/20 my-3 pt-3">
                            <div class="flex justify-between font-bold">
                                <span class="text-[#F5F5F5]">Total:</span>
                                <span class="text-[#C9A45A] text-xl" id="totalPrice">₦0</span>
                            </div>
